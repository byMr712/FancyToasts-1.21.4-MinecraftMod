...
## Description of my fork
This fork was created to complete the version for Minecraft 1.21.4—and exclusively for that version; if you need other versions, please check the [original repository](https://github.com/Bivrik/FancyToasts) and the [Modrinth](https://modrinth.com/mod/fancy-toasts) or [CurseForge](https://www.curseforge.com/minecraft/mc-mods/fancy-toasts).
...
This fork was created to complete the version for Minecraft 1.21.4 — and exclusively for that version:
